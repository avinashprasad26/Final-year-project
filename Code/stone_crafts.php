...
//echo"$idd";
$showquery="select * from sell where arttype = 'stone_crafts' and username!='$ids'";
        ...
        <div class="col-3">
          ...
          <div class="card border-dark shadow text-center" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <!--<a href="cart.php" name="button" value="" class="btn btn-warning">Add to cart</a>-->
            </div>
          </div>
          </form>
        </div>
